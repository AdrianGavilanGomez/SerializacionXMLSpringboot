...
public class EmpresaRepository {
	...
	public void add(Empresa empresa) {
		...
		if (empresaDb == null) {
			...
			throw new RuntimeException("La empresa amb CIF " + empresa.getCif() + " ja existeix.");
	...
	public void update(Empresa empresa) {
		...
		if (empresaDb != null) {
			...
			throw new RuntimeException("La empresa amb CIF " + empresa.getCif() + " no existeix.");
	...
	public void delete(String cif) {
		...
		if (empresaDb != null) {
			...
			throw new RuntimeException("La empresa amb CIF " + cif + " no existeix.");
